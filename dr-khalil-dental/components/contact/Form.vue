<template>
  <div class="bg-navy-50 rounded-2xl p-6 md:p-8 border border-slate-700">
    ...
    >
      ...
      <button
        type="submit"
        class="w-full bg-whatsapp hover:brightness-110 text-white font-semibold px-6 py-3 rounded-lg transition-all duration-300 hover:scale-[1.02] active:scale-95 flex items-center justify-center gap-2"
      >
